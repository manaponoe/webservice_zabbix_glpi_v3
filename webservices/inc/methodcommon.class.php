<?php
/**
 * @version $Id: methodcommon.class.php 478 2019-12-12 15:26:07Z yllen $
 -------------------------------------------------------------------------
 LICENSE
   ...
   **/
   static function methodListDropdownValues($params, $protocol) {
      ...
      if (isset($params['name'])) {
         ...
         $query['WHERE'][$name] = ['LIKE' , addslashes($params['name'])];
      }
      if ($item->isEntityAssign()) {
         $query['WHERE'] =  $dbu->getEntitiesRestrictCriteria($table, '', '', $item->maybeRecursive());
      }
